...
export default class Ajouter_scanne_non_connecte extends Component {
  ...
  render() {
    ...
    return (
      ...
      <View style={{
        ...
        <View style={styles.vuebar}  >
          <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
            <Text style={{ fontSize: 20, fontWeight: 'bold', }}> Ce produit n'existe pas, inscrivez vous
   	  		</Text>
          </View>
          <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
            <Text style={{ fontSize: 20, fontWeight: 'bold', }}>  ou connectez vous pour l'ajouter
   	  		</Text>
          </View>
        </View>
